...
{
	private static final HashMap<String, Tuple<Choice, Choice>> DefaultConfirmChoices = new HashMap<String, Tuple<Choice, Choice>>(Map.ofEntries(Map.entry(Spanish, new Tuple<Choice, Choice>(new Choice {Value = "Sí"}, new Choice {Value = "No"})), Map.entry(Dutch, new Tuple<Choice, Choice>(new Choice {Value = "Ja"}, new Choice {Value = "Nee"})), Map.entry(English, new Tuple<Choice, Choice>(new Choice {Value = "Yes"}, new Choice {Value = "No"})), Map.entry(French, new Tuple<Choice, Choice>(new Choice {Value = "Oui"}, new Choice {Value = "Non"})), Map.entry(German, new Tuple<Choice, Choice>(new Choice {Value = "Ja"}, new Choice {Value = "Nein"})), Map.entry(Japanese, new Tuple<Choice, Choice>(new Choice {Value = "はい"}, new Choice {Value = "いいえ"})), Map.entry(Portuguese, new Tuple<Choice, Choice>(new Choice {Value = "Sim"}, new Choice {Value = "Não"})), Map.entry(Chinese, new Tuple<Choice, Choice>(new Choice {Value = "是的"}, new Choice {Value = "不"}))));
...
//C# TO JAVA CONVERTER TODO TASK: There is no equivalent to 'await' in Java:
	...
	@Override
	protected Task<PromptRecognizerResult<Boolean>> OnRecognizeAsync(ITurnContext turnContext, java.util.Map<String, Object> state, PromptOptions options)
	{
		return OnRecognizeAsync(turnContext, state, options, null);
	}

//C# TO JAVA CONVERTER NOTE: Java does not support optional parameters. Overloaded method(s) are created above:
//ORIGINAL LINE: protected override Task<PromptRecognizerResult<bool>> OnRecognizeAsync(ITurnContext turnContext, IDictionary<string, object> state, PromptOptions options, CancellationToken cancellationToken = default(CancellationToken))
	@Override
	protected Task<PromptRecognizerResult<Boolean>> OnRecognizeAsync(ITurnContext turnContext, Map<String, Object> state, PromptOptions options, CancellationToken cancellationToken)
	{
		if (turnContext == null)
		{
			throw new NullPointerException("turnContext");
